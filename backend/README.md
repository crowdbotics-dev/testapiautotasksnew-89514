...
## Project Structure
    ...
    ├── testapiautotasksnew_89514  # Django project configurations
...
1. Clone this repo and `cd testapiautotasksnew_89514`
...
2. Clone this repo and `cd testapiautotasksnew_89514`
